...
export async function generateMetadata({
  ...
  const url = absoluteUrl(locale, '/terms');
      ...
      <div className="container-narrow">
        ...
        <BreadcrumbSchema
          items={[
            ...
            { name: t('breadcrumb'), url: absoluteUrl(locale, '/terms') }
          ]}
        />
        <WebPageSchema locale={locale} path="/terms" name={t('title')} description={t('description')} />
